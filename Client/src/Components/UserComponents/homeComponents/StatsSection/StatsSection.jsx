    ...
    <div className={styles.statsSection}>
      ...
      <div className={styles.statsContainer}>
        <div className={styles.statBox}>
          ...
          <h3>27+</h3>
          <p className={styles.statText} style={{ color: '#ff0066' }}>Years of Trust</p>
        ...
        <div className={styles.statBox}>
          ...
          <h3>1000000+</h3>
          <p className={styles.statText} style={{ color: '#ff0066' }}>Active Profiles</p>
        ...
        <div className={styles.statBox}>
          ...
          <h3>10000+</h3>
          <p className={styles.statText} style={{ color: '#ff0066' }}>Member Visits Everyday</p>
        ...
        <div className={styles.statBox}>
          ...
          <h3>1500+</h3>
          <p className={styles.statText} style={{ color: '#ff0066' }}>Successful Marriages</p>
