...
const UserExpectationsDetails = async (req, res) => {
  try {
    const {
      firstname,
      middlename,
...
const getUserExpectationsDetails = async (req, res) => {
  try {
...
const getSingleUserExpectationsDetails = async (req, res) => {
  try {
...
const updateUserExpectationsDetails = async (req, res) => {
  try {
    const uid = req.params.userid;
...
module.exports = {
  UserExpectationsDetails,
  getUserExpectationsDetails,
  getSingleUserExpectationsDetails,
  updateUserExpectationsDetails,
};
